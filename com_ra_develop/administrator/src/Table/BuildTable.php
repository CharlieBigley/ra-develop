 ...
 * @since 0.1.0
 */
class BuildTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ra_develop.build';
		parent::__construct('#__ra_builds', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_ra_develop.build.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ra_develop/access.xml',
				"/access/section[@name='build']/"
			);
			$default_actions = Access::getAssetRules('com_ra_develop.build.' . $array['id'])->getData();
			$array_jaccess   = array();
