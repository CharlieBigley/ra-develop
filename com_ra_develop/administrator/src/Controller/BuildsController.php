...
/**
 * Builds list controller class.
 *
 * @since  0.1.0
 */
class BuildsController extends AdminController
{
	    public function cancel($key = null, $urlVar = null) {
        $this->setRedirect('index.php?option=com_ra_tools&view=dashboard');
    }
	/**
	 * Method to clone existing Builds
	 *
	 * @return  void
	 *
	 * @throws  Exception
	 ...
	 * @since   0.1.0
	 */
	public function getModel($name = 'Build', $prefix = 'Administrator', $config = array())
	{
