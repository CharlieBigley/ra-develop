 ...
 * 04/02/26 CB correct page heading
 */

namespace Ramblers\Component\Ra_develop\Administrator\View\Extensions;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('Extensions'), "generic");
        ...
        ToolbarHelper::cancel('extensions.cancel', 'Return to Dashboard');

		// Set sidebar action
		Sidebar::setAction('index.php?option=com_ra_develop&view=components');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`subsystem_id`' => Text::_('COM_RA_DEVELOP_COMPONENTS_SUBSYSTEM_ID'),
			'a.`name`' => Text::_('COM_RA_DEVELOP_COMPONENTS_NAME'),
		);
	}
