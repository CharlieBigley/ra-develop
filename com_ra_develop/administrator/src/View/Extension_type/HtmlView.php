...
namespace Ramblers\Component\Ra_develop\Administrator\View\Extension_type;
// No direct access
...
/**
 * View class for a single Extension_type.
 *
 * @since  0.3.0
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		{
			ToolbarHelper::cancel('extension_type.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			ToolbarHelper::cancel('extension_type.cancel', 'JTOOLBAR_CLOSE');
		}
	}
}
