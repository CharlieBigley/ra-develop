...
/**
 * Methods supporting a list of Hy_schema records.
 *
 * @since  1.0.1
 */
class SchemataModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_HY_SCHEMA_SEARCH_FILTER_DATE_FORMAT"), "warning");
