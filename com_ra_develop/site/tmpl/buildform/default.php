...
$lang->load('com_ra_develop', JPATH_SITE);

$user    = Factory::getApplication()->getIdentity();
$canEdit = Ra_developHelper::canUserEdit($this->item, $user);


?>

<div class="build-edit front-end-edit">
...
<?php if ($this->params->get('show_page_heading')) : ?>
	...
	<?php if (!$canEdit) : ?>
		<h3>
		<?php throw new \Exception(Text::_('COM_RA_DEVELOP_ERROR_MESSAGE_NOT_AUTHORISED'), 403); ?>
		</h3>
	<?php else : ?>
		...
		<form id="form-build"
			  action="<?php echo Route::_('index.php?option=com_ra_develop&task=buildform.save'); ?>"
	...
	<?php echo $this->form->renderField('replace'); ?>
			...
			<input type="hidden" name="option" value="com_ra_develop"/>
			<input type="hidden" name="task"
				   value="buildform.save"/>
