...
### Template 4: API Controller (`api/src/Controller/{Table}Controller.php`)
...
### Template 5: JSON API View (`api/src/View/{Table_plural}/JsonapiView.php`)
...
- [ ] **Update Manifests**
  - [ ] Update component manifest to include `<folder>api/src</folder>` in API section
  - [ ] Add API namespace: `<namespace path="api/src">Ramblers\Component\Ra_{project}\Api</namespace>`
